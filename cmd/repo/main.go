...
import (
	...
	services "github.com/bayramguenes/tim_github_cli_dbdef.git/pkg/services/repo"
...
func main() {
	...
	gvDatabase = gvConf.DB_databases.Repo
...
func reading_console(iConf conf.ConfStruct) {
	...
	gvConf := conf.GetConfig(lConfLocation)
	println("database:", gvConf.DB_databases.Repo)
