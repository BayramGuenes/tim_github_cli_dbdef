...
import (
	...
	services "github.com/bayramguenes/tim_github_cli_dbdef.git/pkg/services/receiver"
...
func main() {
	...
	gvDatabase = gvConf.DB_databases.Receiver
...
func reading_console(iConf conf.ConfStruct) {
	...
	gvConf := conf.GetConfig(lConfLocation)
	println("database:", gvConf.DB_databases.Receiver)
	for {
		fmt.Print("-> ")
